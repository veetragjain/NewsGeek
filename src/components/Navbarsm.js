  ...
  return (
    ...
    <div className={`flex bg-black lg:hidden sticky top-0 z-10 items-center`}>
      <Link to="/" className={`flex items-center`}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" onClick={menuSetClick} className={`h-5 w-5 ${menuSet} ml-auto mr-3 text-pink-500`}
             viewBox="0 0 20 20" fill="currentColor">
            <path fillRule="evenodd"
              d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM9 15a1 1 0 011-1h6a1 1 0 110 2h-6a1 1 0 01-1-1z"
              clipRule="evenodd" />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" onClick={menuCrossClick} className={`h-6 w-6 ${menuCross} ml-auto mr-3 text-pink-500`}
            id="cross" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
              d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
    </div>
    <div className={`flex-col ${menuCross} bg-gray-100 lg:hidden w-[60%] z-0 absolute ml-[40%] h-[120%]`}>
      <div onClick={() => optionClick1("general")} className={`flex ${props.category=="general"?"bg-gradient-to-r from-purple-400 to-pink-600":""} py-2 justify-center`}>
      ...
      <div onClick={() => optionClick1("entertainment")} className={`flex ${props.category=="entertainment"?"bg-gradient-to-r from-purple-400 to-pink-600":""} py-2 justify-center`}>
      ...
      <div onClick={() => optionClick1("health")} className={`flex ${props.category=="health"?"bg-gradient-to-r from-purple-400 to-pink-600":""} py-2 justify-center`}>
      ...
      <div onClick={() => optionClick1("sports")} className={`flex ${props.category=="sports"?"bg-gradient-to-r from-purple-400 to-pink-600":""} py-2 justify-center`}>
      ...
      <div onClick={() => optionClick1("science")} className={`flex ${props.category=="science"?"bg-gradient-to-r from-purple-400 to-pink-600":""} py-2 justify-center`}>
      ...
      <div onClick={() => optionClick1("technology")} className={`flex ${props.category=="technology"?"bg-gradient-to-r from-purple-400 to-pink-600":""} py-2 justify-center`}>
      ...
      <div onClick={() => optionClick1("business")} className={`flex ${props.category=="business"?"bg-gradient-to-r from-purple-400 to-pink-600":""} py-2 justify-center`}>
